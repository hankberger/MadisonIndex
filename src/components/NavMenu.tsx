...
export default function NavMenu(){
    ...
    return(
         <nav className='animate-bottomFade flex flex-row max-w-5xl justify-around items-center fixed bottom-0 h-20 w-full bg-white rounded-t-xl'>
          <div className='w-5/12 h-full rounded-3xl flex flex-row justify-around items-center bg-white'>
            <Link href="/" onClick={()=>handleSelect(features.home)} className="w-12 h-12 flex items-center justify-center rounded-md">
            ...
            <Link href={`/${features.events}`} onClick={()=>handleSelect(features.events)} className="w-12 h-12 flex items-center justify-center">
        ...
        <div className=" flex justify-center items-center h-12 w-12 bg-indigo-400 rounded-xl">
          ...
          <div className='w-5/12 h-full rounded-3xl flex flex-row justify-around items-center bg-white'>
            <Link href={`/${features.market}`} onClick={()=>handleSelect(features.market)} className="w-12 h-12 flex items-center justify-center">
            ...
            <Link href={`/${features.explore}`} onClick={()=>handleSelect(features.explore)} className="w-12 h-12 flex items-center justify-center">
